...
p_cycle_inc = generate_mo('parameter');
p_cycle_inc.ATTRIBUTE.name = 'cycle_increment_sec';
p_cycle_inc.ATTRIBUTE.value = 0.5;
a_actuator = struct( ...
    ...
    'parameters',struct('parameter',[p_max_queue_vehicles p_max_rate p_min_rate p_cycle_inc]),...
