...
X(i).out_file           = fullfile(X(i).folder_rm,'680N_rm_nooverride_up.xml');
X(i).up_or_down         = 'up';
...
X(i).config_file        = fullfile(X(i).folder_base,'680N.xml');
X(i).folder_rm          = fullfile(root,'config','680N_+RM_2013');
X(i).out_file           = fullfile(X(i).folder_rm,'680N_rm_override_up.xml');
X(i).up_or_down         = 'up';
X(i).alinea_gain_value  = alinea_gain_value;
...
% X(i).config_file        = fullfile(X(i).folder_base,'680N.xml');
% X(i).folder_rm          = fullfile(root,'config','680N_+RM_2013');
% X(i).out_file           = fullfile(X(i).folder_rm,'680N_rm_nooverride_dn.xml');
% X(i).up_or_down         = 'down';
% X(i).alinea_gain_value  = alinea_gain_value;
% X(i).queue_limit        = inf;
%             
...
% X(i).config_file        = fullfile(X(i).folder_base,'680N.xml');
% X(i).folder_rm          = fullfile(root,'config','680N_+RM_2013');
% X(i).out_file           = fullfile(X(i).folder_rm,'680N_rm_override_dn.xml');
% X(i).up_or_down         = 'down';
% X(i).alinea_gain_value  = alinea_gain_value;
% X(i).queue_limit        = queue_limit;
...
X(i).out_file           = fullfile(X(i).folder_rm,'680S_rm_nooverride_up.xml');
X(i).up_or_down         = 'up';
X(i).alinea_gain_value  = alinea_gain_value;
X(i).queue_limit        = inf;
...
X(i).config_file        = fullfile(X(i).folder_base,'680S.xml');
X(i).folder_rm          = fullfile(root,'config','680S_+RM_2013');
X(i).out_file           = fullfile(X(i).folder_rm,'680S_rm_override_up.xml');
X(i).up_or_down         = 'up';
X(i).alinea_gain_value  = alinea_gain_value;
X(i).queue_limit        = queue_limit;
...
% X(i).config_file        = fullfile(X(i).folder_base,'680S.xml');
% X(i).folder_rm          = fullfile(root,'config','680S_+RM_2013');
% X(i).out_file           = fullfile(X(i).folder_rm,'680S_rm_nooverride_dn.xml');
% X(i).up_or_down         = 'down';
% X(i).alinea_gain_value  = alinea_gain_value;
% X(i).queue_limit        = inf;
%             
...
% X(i).config_file        = fullfile(X(i).folder_base,'680S.xml');
% X(i).folder_rm          = fullfile(root,'config','680S_+RM_2013');
% X(i).out_file           = fullfile(X(i).folder_rm,'680S_rm_override_dn.xml');
% X(i).up_or_down         = 'down';
% X(i).alinea_gain_value  = alinea_gain_value;
% X(i).queue_limit        = queue_limit;
